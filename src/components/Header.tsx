              ...
              <div className="text-gray-600 dark:text-gray-300 lg:pr-4 lg:w-auto w-full lg:pt-0">
                <ul className="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0">
                  {!userId ? (
                    <>
                      <Link href="/sign-in">
                        <li className="block md:px-4 transition hover:text-primary">Login</li>
                      </Link>
                      <Link href="/sign-up">
                        <li className="block md:px-4 transition hover:text-primary">Sign Up</li>
                      </Link>
                    </>
                  ) : (
                    <>
                      <Link href="/profile">
                        <li className="block md:px-4 transition hover:text-primary">Profile</li>
                      </Link>
